...
public class ProductEventListener {
    ...
    @RabbitListener(queues = "order-created-queue-notification")
    public void handleOrderCreated(com.uade.notification.event.OrderCreatedEvent event) {
        log.info("=== NOTIFICACIÓN DE ORDEN RECIBIDA ===");
